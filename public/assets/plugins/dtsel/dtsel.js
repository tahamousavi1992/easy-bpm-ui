(function () {
    ...
    */
    ...
    DTS.prototype.inputElemHandler = function (e) {
        if (e.type == "focus") {
            //start taha (add this.inputElem.readOnly != true)
            if (this.inputElem.readOnly != true) {
                if (!this.dtbox) {
    ...
    DTBox.prototype.setupWrapper = function () {
        ...
        function handler(e) {
            //start taha (add this.inputElem.readOnly != true)
            if (!self.settings.config.showTime &&
                e.target.closest('.cal-days') != null &&
    ...
    DTBox.prototype.setInputValue = function () {
        ...
        //taha change to compatible with react event change fire
        //this.elem.value = strings.join(', ');
        var nativeInputValueSetter = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, "value").set;
        nativeInputValueSetter.call(this.elem, strings.join(', '));
