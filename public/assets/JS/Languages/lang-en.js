 var langEn = {
     FG:
     {
         ...
         textBoxTypejustCharacter: 'Only letters',
         textBoxTypejustNumber: 'Only numbers',
         textBoxTypepostalCode: 'Postal Code',
         textBoxTypemobile: 'Mobile',
         textBoxTypejustEnglishCharacter: 'Only English letters',
         ...
         //buttonEDitMode
         txtExpressionConfirmCode: 'تابع بررسی نمایش تاییدیه',
         confirmText: 'متن تاییدیه',
         btnStyle: 'Style',
