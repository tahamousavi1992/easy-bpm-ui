 var langEn = {
     FG:
     {
         ...
         //buttonEDitMode
         txtExpressionConfirmCode: "Define Confirmation's Condition",
         confirmText: 'Confirmation Message',
         btnStyle: 'Style',
         addBackendCoding: 'Design Actions',
         CoddingDiv: 'Code',
         ...
         hasFalseActionField: 'Can It Continue if click no?',
         //CaptchaEditMode
         ...
         txtDataGridItemConfirmText: 'Confirmation Message',
         ddlDataGridOpenPopUpFormId: 'Open Form',
