...
class DepartmentMemberService {
    ...
    async delete(userID, departmentID) {
        return await new UtilityService().deleteData(new BpmsConfig().AdminUrl + 'BpmsDepartmentMember/Delete', { UserID: userID, DepartmentID: departmentID });
    }
}
