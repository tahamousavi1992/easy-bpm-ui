...
class GetThreadDetail extends React.Component {
    ...
    async updateForm() {
        let data = await new CartableManageService().getThreadDetail(this.props.match.params.threadId);
        this.props.setPageCaption(3, [Lang.GetThreadDetail.caption, Lang.Menu.ThreadList], false);
